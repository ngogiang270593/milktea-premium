export const vi = {
  ...
  navbar: {
    ...
    openWishlist: 'Mở danh sách yêu thích',
    openCart: 'Mở giỏ hàng',
    wishlistCount: '{count} món yêu thích',
    cartCount: '{count} sản phẩm trong giỏ'
  },
  buttons: {
    login: 'Đăng nhập',
    register: 'Đăng ký',
  ...
  menu: {
    ...
    emptyTitle: 'Không có món phù hợp với bộ lọc.',
    emptyCopy: 'Hãy thử xóa bộ lọc, đổi danh mục hoặc tìm một món trà sữa yêu thích khác.',
  ...
  productDetail: {
    ...
    quantityInputAria: 'Nhập số lượng sản phẩm',
    decreaseQuantity: 'Giảm số lượng',
    increaseQuantity: 'Tăng số lượng',
    noExtraToppings: 'Không thêm topping',
  ...
  home: {
    ...
    featured: {
      ...
      add: 'Thêm',
      discountAria: 'Giảm {discount} phần trăm',
      favoriteAria: 'Thêm {title} vào danh sách yêu thích',
    ...
    instagram: {
      ...
      items: [
        ...
        {
          label: 'Hương vị mùa hè tươi mát'
        },
        {
          label: 'Không gian cafe cao cấp tối giản'
        },
        {
          label: 'Trà và trân châu được tạo hình tinh tế'
        }
      ]
    },
    newsletter: {

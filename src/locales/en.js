export const en = {
  ...
  navbar: {
    ...
    wishlistCount: '{count} saved wishlist items',
  ...
  menu: {
    ...
    emptyTitle: 'No drinks match your filters.',
    emptyCopy: 'Try clearing filters, changing the category, or searching for another milk tea favorite.',
  ...
  productDetail: {
    ...
    quantityInputAria: 'Enter product quantity',
    decreaseQuantity: 'Decrease quantity',
    increaseQuantity: 'Increase quantity',
    noExtraToppings: 'No extra toppings',

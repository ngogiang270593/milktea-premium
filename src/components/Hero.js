    ...
    <section id="home" class="premium-hero relative isolate overflow-hidden hero-gradient" aria-labelledby="hero-title">
      ...
      <div class="relative mx-auto grid min-h-[calc(100vh-5rem)] max-w-7xl items-center gap-16 px-6 pb-20 pt-24 sm:pt-28 lg:grid-cols-[1.02fr_0.98fr] lg:px-8 lg:pb-24 lg:pt-24">
        <div class="hero-copy max-w-2xl">
          ...
          <div class="fade-up mt-10 grid gap-4 sm:grid-cols-3" aria-label="Store highlights">
        ...
        <div class="hero-visual relative mx-auto h-[34rem] w-full max-w-[34rem] sm:h-[40rem]" data-parallax-scene role="img" aria-label="Illustration of a premium bubble tea drink with brown sugar pearls and cream topping">

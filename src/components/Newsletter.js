      ...
      <div class="glass-panel rounded-[2rem] border border-brand-green/15 p-8 sm:p-14">
        <div class="grid gap-10 lg:grid-cols-[1fr_360px] lg:items-center">
          ...
          <form class="space-y-5 rounded-3xl bg-white p-6 shadow-[0_18px_44px_rgba(48,35,24,0.08)]" aria-label="${t('home.newsletter.formAria')}">
            ...
            <input id="newsletter-email" name="email" type="email" autocomplete="email" placeholder="${newsletter.placeholder}" required aria-required="true" class="w-full rounded-3xl border border-gray-200 bg-gray-50 px-5 py-4 text-sm font-medium text-gray-800 outline-none transition focus:border-brand-green focus:bg-white focus:ring-2 focus:ring-brand-mint/50" />

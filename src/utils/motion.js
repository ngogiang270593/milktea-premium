...
function initCardStaggers() {
  const cardSelectors = '.category-card, .trust-card, .about-card, .about-stat, .about-team-card, .contact-method-card, .contact-faq-link, .product-card, .featured-premium-card, .menu-product-card, .testimonial-card, .instagram-tile, .wishlist-item, .cart-item';
